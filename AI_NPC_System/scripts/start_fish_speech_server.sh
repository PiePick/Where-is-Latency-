...
REFERENCE_ID="${FISH_SPEECH_REFERENCE_ID:-credo_edge_ana_english_v1}"
REFERENCE_SOURCE="${FISH_SPEECH_REFERENCE_SOURCE:-edge_tts:en-US-AnaNeural;vendor/fish-speech/references/credo_edge_ana_english_v1}"
EDGE_REFERENCE_VOICE="${FISH_SPEECH_EDGE_REFERENCE_VOICE:-en-US-AnaNeural}"
